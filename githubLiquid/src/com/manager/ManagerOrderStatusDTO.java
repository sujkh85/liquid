 ...
 * 작업자 : 이홍수
 * 작업일자 : 14.11.25
 * 어떤 파일에 호출받는가 :  ManagerOrderStatusCMD
 * 어떤 파일을 호출하는가 :  
 * 파일 타입 :  
 ***********************************************************************/
public class ManagerOrderStatusDTO { //주문 상태별 목록 데이터 담을 DTO
	private int    rownum			 ;
    ...
    private int    order_final_money ;//최종결제금액
    private int    order_money ;//최종결제금액
	...
	public ManagerOrderStatusDTO() {
	}
	public ManagerOrderStatusDTO(int rownum, int order_no, String member_info_name,
