...
public class Board_commentVO {
	...
	private int 	 board_review_no        = 0;//
	private int 	 board_comment_replay   = 0;//
	
	
	public Board_commentVO(int board_comment_no, String board_comment_date,
			String board_comment_content, int board_review_no,
			int board_comment_replay) {
		super();
