...
<form id="f_memberForm" name="member_info_form"  action="myinfogo.do" method="post">
<table class="table">
	<tr>
		<td><h5><strong>아이디</strong></h5></td>
		<td><h5><strong>${infoList.getMember_info_id()}</strong></h5></td>
	</tr>
	<tr>
		<td><h5><strong>닉네임</strong></h5></td>
		<td><input class="form-control" placeholder="닉네임을 입력해주세요" type="text" size="7" maxlength="12" id="member_info_nickname" name="member_info_nickname" value="${infoList.getMember_info_nickname()}">
		</td>
		<td>
	...
	<td><h5><strong>비밀번호</strong></h5></td>
		<td ><input class="form-control" placeholder="비밀번호를 입력해주세요" type="password" size="10" maxlength="12" name="member_info_pw" >
		</td>
	</tr>
	<tr>
		<td><h5><strong>비밀번호확인</strong></h5></td>
		<td><input class="form-control" placeholder="다시 비밀번호를 입력해주세요" type="password" size="10" maxlength="12" name="member_info_pw2">
		</td>
		<td>
		</td>
	</tr>
	...
	<tr>
		...
		<td><h5><strong>${infoList.getMember_info_name()}</strong></h5></td>
	</tr>
	<tr>
		<td><h5><strong>생일</strong></h5></td>
		<td><input class="form-control" placeholder="생일을 입력해주세요" type="text" value="${infoList.getMember_info_birthday()}" name="member_info_birthday">
	...
	<tr>
		...
		<input class="btn btn-success" type="button" value="돌아가기" onclick="location.href='memberpage.do'">
		</td>  
	</tr>
</table>
</form>
