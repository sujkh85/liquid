 ...
 ***********************************************************************/
  --> 
  <style type="text/css">
.star_rating{width:100px;height:20px;background:url(bg_starpoint_off.gif) 0 0 no-repeat; background-size: 100px; 20px;}
.star_rating span{display:block;height:15px;background:url(bg_starpoint_on.gif) 0 0 no-repeat; background-size: 100px; 20px;}
...
<body onload="javascript:starpoint()">
    ...
    <div class="easyui-tabs" style="width:auto; height:auto; clear: both; " >
        ...
        <!-- 구매후기에 대한 테그 -->
        <div title="구매후기" style="padding:10px; background-color:#ffdfdf;">
        <div title="상품평">
        	...
        	<c:forEach items="${reviewList}" var="review">
					<tr bgcolor="#EEF4F4" >
						...
						<c:if test="${review.getMember_info_nickname() == nick }" >
							...
							<input type="button" onclick="delete_b(${review.getBoard_review_no()})" value="삭제"/> </td>
						</c:if> 
