...
<table class="table" align="center">
	<tr> 
		...
		<td colspan="2"><input size="10" class="form-control" placeholder="아이디를 입력해주세요" type="text"  maxlength="12" id="member_info_id" name="member_info_id">
		</td>
		<td>
	...
	<tr>
		...
		<td colspan="2"><input class="form-control" placeholder="닉네임을 입력해주세요" type="text" size="10" maxlength="12" id="member_info_nickname" name="member_info_nickname" >
		</td>
		<td>
	...
	<tr>
		<td colspan="4" align="center"><h2>개인정보 입력</h2></td>
	</tr>
	<tr>
		<td><h5><strong>이름</strong></h5></td>
		<td colspan="2"><input class="form-control" placeholder="이름을 입력해주세요" type="text" size="10" maxlength="12" name="member_info_name"/></td>
	</tr>
	...
	<tr>
		...
		<td colspan="2"><input class="form-control" placeholder="연락처를 입력해주세요"type="text" name="member_info_phone" size="15" maxlength="15"></td>
	</tr>
	<tr>
		<td><h5><strong>이메일</strong></h5></td>
		<td colspan="2"><input class="form-control" placeholder="이메일을 입력해주세요" type="text" name="member_info_email" size="40" maxlength="30"></td>
	</tr>
	<tr>
