...
<form action="memberform.do" name="form" method="post">
 <div>
   ...
   <span style="padding-left: 40px"><b>회원가입</b></span>
   <hr>
 </div>
 <div style="padding-top: 50px">
   <span style="margin: 0px auto"><strong><h3>Liquid 약관동의</h3></strong></span>
...
<div>
   ...
   <br><div align="center">
    <input class="btn btn-info" type="button" value="동의" onclick="chk()"/>&nbsp;&nbsp;&nbsp;
    <input class="btn btn-info" type="button" value="동의하지 않습니다" onclick="alert('약관에 동의하지 않으면 가입 하실 수 없습니다.')"/>
    </div>
</div>
</form>
</body>
